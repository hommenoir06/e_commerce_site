<?php
/** @noinspection ALL */
function getProductFemme():array{
    $sql = "SELECT * FROM product WHERE type='femme'";
...
// affichage des produit pour les hommes 
function getProductHomme():array{
    $sql = "SELECT * FROM product WHERE type='homme' ";
    $result = getDb()->prepare($sql);
    if (!$result){
        return [];
    }
